...
namespace Drboum.Utilities.Runtime.EditorHybrid {
    ...
    [ExecuteInEditMode]
    public abstract class AssetObjectDirector : EditorCallBackMonoBehaviour<AssetObjectDirector>
#if UNITY_EDITOR
        , IAssetDirector
#endif
        , IAuthoring {
    ...
    public abstract class AssetObjectDirector<T> : AssetObjectDirector
        ...
        protected void CreateAssetAndOverrideGuid(bool saveAssets = true)
        {
            ...
            string path = default;
            AssetObject.OverWriteGuidInMetaFile(_editorObjectTracker.AssetGuid, ref path);
