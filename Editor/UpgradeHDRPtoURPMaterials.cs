...
namespace DrboumLibrary.Editors {
    internal class UpgradeHDRPtoURPMaterials {
        private static List<MaterialUpgrader> GetHDtoURPUpgraders()
        {
            var upgraders = new List<MaterialUpgrader>();
            upgraders.Add(new HDLitToURPLitMaterialUpgrader("HDRP/Lit", "Universal Render Pipeline/Lit",
                HDLitToURPLitMaterialUpgrader.ConvertHDRPtoURPMaterialKeywords));
            return upgraders;
        }
        ...
        [MenuItem("Edit/Render Pipeline/Convert Selected HDRP Materials to URP",
            priority = CoreUtils.editMenuPriority2)]
    ...
    internal class HDLitToURPLitMaterialUpgrader : MaterialUpgrader {
        public HDLitToURPLitMaterialUpgrader(string sourceShaderName, string destShaderName,
        ...
        private static void UpdateSurfaceTypeAndBlendMode(Material material)
        {
